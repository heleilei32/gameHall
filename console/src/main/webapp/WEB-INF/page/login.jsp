...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="${project}/resources/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${project}/resources/css/ace-part2.min.css" />
		<![endif]-->
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">刀传</span>
									<span class="white" id="id-text2">游戏管理平台</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; 刀传网络科技有限公司</h4>
							</div>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="用户名"
																   ...
																   oninput="setCustomValidity('')" required value="${userName}" name="userName"/>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="密码"
																   ...
																   oninput="setCustomValidity('')" required value="${password}" name="password"/>
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>

													<div class="space"></div>
													<div style="text-align: center;font-size: 17px;color: red;"  >${errMsg}</div>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='${project}/resources/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
